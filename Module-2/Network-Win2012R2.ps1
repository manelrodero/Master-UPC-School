...
if ($ip) {
    New-NetIPAddress -InterfaceIndex $ip.InterfaceIndex -IPAddress 192.168.56.9 -PrefixLength 24
...
if ($ip) {
    ...
    New-NetIPAddress -InterfaceIndex $ip.InterfaceIndex -IPAddress 10.0.20.9 -PrefixLength 24 -DefaultGateway $gw
...
Rename-Computer -NewName "win2012r2" -Restart
